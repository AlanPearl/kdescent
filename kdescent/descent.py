...
def adam(lossfunc, init_params, nsteps=100, param_bounds=None,
    ...
    if param_bounds is None:
        return adam_unbounded(lossfunc, init_params, nsteps,
...
def adam_unbounded(lossfunc, init_params, nsteps=100,
